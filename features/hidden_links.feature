Feature: Hidden Links
	...
	Scenario: New ticket link is shown to a user with permissions
	...
	Scenario: New ticket link is hidden from a user without permissions
		Given "user@ticketee.com" can view the "TextMate 2" project
		And I am signed in as "user@ticketee.com"
		When I follow "TextMate 2"
	...
	Scenario: Edit ticket link is hidden from a user without permissions
		Given "user@ticketee.com" can view the "TextMate 2" project
		And I am signed in as "user@ticketee.com"
		When I follow "TextMate 2"
		And I follow "Shiny!"
	...
	Scenario: Delete ticket link is hidden from a user without permissions
		Given "user@ticketee.com" can view the "TextMate 2" project
		And I am signed in as "user@ticketee.com"
		When I follow "TextMate 2"
		And I follow "Shiny!"
